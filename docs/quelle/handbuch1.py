...
<section id="a11">
  ...
  <p>
    ...
    einzurichten &ndash; ohne Geräteverwaltung. Sie erzeugen den Code hier, geben ihn
    weiter und sehen, wie oft er verwendet wurde.
  </p>
  <h3>Single Sign-On</h3>
  <p>
    Die Anmeldung über Microsoft Entra ID ist vorbereitet, aber nicht aktiv. Solange
    sie ausgeschaltet ist, gelten E-Mail-Adresse und Passwort.
  </p>
</section>
