...
- **Alarmierung auf dem iPhone:** Nicht stille Alarme werden als Critical Alert zugestellt – sie klingeln auch bei stummgeschaltetem Telefon. Solange Apple die dafür nötige Bewilligung nicht erteilt hat, gilt die Stufe «zeitkritisch», die immerhin Fokus-Modi durchbricht (siehe [`mobile/CRITICAL-ALERTS.md`](mobile/CRITICAL-ALERTS.md)). Stille Alarme bleiben lautlos.
